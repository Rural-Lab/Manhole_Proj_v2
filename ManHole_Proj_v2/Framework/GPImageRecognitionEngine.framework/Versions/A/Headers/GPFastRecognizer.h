...
/*!
 @class GPFastRecognizer
 @abstract 高速な画像検出機能を提供する。
 */
@interface GPFastRecognizer : GPRecognizerAbstract
...
/*!
 @property descriptorThreshold
 @abstract 特徴点マッチングの閾値
 @discussion 大きいほど条件は厳しくなる。<br>
 既定値: 0.85<br>
 有効値: 0.00 ~ 1.00
 */
@property (nonatomic) float descriptorThreshold;

/*!
 @property recognitionThreasholdRatio
 @abstract データセット側の特徴点のうちいくら検出したら画像を認識とするかの閾値。
 @discussion 大きいほど条件は厳しくなる。<br>
 既定値: 0.05<br>
 有効値: 0.00 ~ 1.00
 */
@property (nonatomic) float recognitionThresholdRatio;

/*!
 @property matchingType
 @abstract 特徴点間のマッチング手法<br>
 既定値: GPDynamicValueMatching
 */
@property (nonatomic) GPFastRecognizerMatchingType matchingType;
 ...
 */
-(void)loadFromPath:(NSString*)filePath fileName:(NSString*)fileName;
 ...
 */
-(NSDictionary*) recognitionWithUIImage:(UIImage*)image;	//認識処理
